...
export default function SignupScreen() {
  ...
  const isStep1ValidPure = () => {
    ...
    if (usernameAutoGenerated) {
      return usernameStatus === 'available' || (usernameStatus === null && !checkingUsername);
    }
              ...
              {step === 1 && (
                <>
                  ...
                  <View>
                    ...
                    {showRegenerateOption || usernameStatus === 'taken' ? (
                      <TouchableOpacity
                        onPress={() => {
                          const addNumber = usernameStatus === 'taken';
                          const generated = generateUsername(addNumber);
                      ...
                      >
                        ...
                        >
                          {usernameStatus === 'taken'
                            ? 'Gerar nome de usuário com número'
